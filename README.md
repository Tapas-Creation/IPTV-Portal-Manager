...
Click the "Test Account & Get Categories" button. Choose your preferred stream categories or select "All Categories" as needed.
...
Seamlessly copy, move, or drag and drop channels back and forth between the panels.

Preview streams instantly with built-in player support for each panel, and export your final edited results into a clean M3U file.
...
Click the "Categories, All or Selected Channels" button, then enter your TVG URL (Logo/URL/ID) in the box and click the "Update Value" button.
